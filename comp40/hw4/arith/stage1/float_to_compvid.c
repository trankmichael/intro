...
static float get_y( rgb_float in )
{
        ...
        return 0.299 * (float)in.red + 0.587 * (float)in.green 
                      + 0.114 * (float)in.blue;
...
static float get_pb( rgb_float in )
{
        ...
        return -0.168736 * (float)in.red - 0.331264 * (float)in.green
                       + 0.5 * (float)in.blue;
...
static float get_pr( rgb_float in )
{
        ...
        return 0.5 * (float)in.red - 0.418688 * (float)in.green
                       - 0.081312 * (float)in.blue;
